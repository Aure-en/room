...
function About() {
  return (
    <Container>
      <Nav />
      <Image src='https://firebasestorage.googleapis.com/v0/b/room-f191c.appspot.com/o/about%2Fabout.jpg?alt=media&token=cdb4b49d-b7dd-4db1-87fb-3388ba0b0dd6' alt='Furnitures' />
      <Center>
        <Content>
